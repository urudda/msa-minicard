...
<div class="container" onsubmit="return false;">
	<div id="withdraw_container">
		...
		<table class="global_table" cellpadding="0" cellspacing="0">
			...
			<tbody>
				...
				<tr>
					...
					<td colspan="3"><span id="acntBlnc"></span> 원</td>
				</tr>
				<tr>
					<th class="width100">출금금액</th>
		...
		<div class="g_tablebtn">
			<input id="btnCreate" type="button" value="출금" class="g_btn_bg" hidden="hidden" />
		</div>
	</div>
	<div id ="withdrawResult_container">
		<br />
		<h2>
			<span>출금 결과</span>
		</h2>
		...
		<br />
		<a  style="float : right;" href="<%=request.getContextPath()%>/account/view/withdraw">돌아가기</a>
	</div>
</div>
<script type="text/javascript"
		src="<%=request.getContextPath()%>/resource/js/account/withdraw.js"></script>